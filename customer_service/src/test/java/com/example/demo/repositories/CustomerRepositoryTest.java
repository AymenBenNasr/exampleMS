...
public class CustomerRepositoryTest {
    ...
    @Test
    void itShouldFindCustomerFirstName() {
        ...
        Optional<Customer> excepted = this.customerRepository.findByFirstName(customer.getFirstName());
        ...
        // On certifie que le prénom du client recherché est le nom que celui qu'on a inséré 
    ...
    @Test
    void itShouldNotFindCustomerWhenFirstNameDoesNotExist() {
        // Given
        ...
        Optional<Customer> customer = this.customerRepository.findByFirstName(fname);

        // Then
        // On certifie qu'il. n'existe aucun client avec ce numéro. 
